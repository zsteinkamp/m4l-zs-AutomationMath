...
,
		"classnamespace" : "box",
		"rect" : [ 306.0, 102.0, 1059.0, 1236.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 341.0, 250.0, 20.848206000000001 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bgoncolor" : [ 0.07843137254902, 0.07843137254902, 0.07843137254902, 1.0 ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 51.0, 512.122925000000009, 44.0, 15.0 ],
					"pictures" : [ "multimap-closed-off.svg", "multimap-open-off.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 3.0, 15.0, 15.0 ],
...
,
					...
					"textoffcolor" : [ 0.588235294117647, 0.588235294117647, 0.588235294117647, 1.0 ],
					"texton" : "-",
					"varname" : "live.text[3]"
				}
...
,
					"patching_rect" : [ 51.0, 470.122925000000009, 59.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 426.122925000000009, 39.0, 20.0 ],
					"text" : "zl sum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 395.122925000000009, 92.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 125.0, 145.0, 29.0, 18.0 ],
					"text" : "Max",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 145.0, 29.0, 18.0 ],
					"text" : "Min",
					"textcolor" : [ 1.0, 1.0, 1.0, 0.46 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 145.0, 63.0, 18.0 ],
					"text" : "Parameter",
					"textcolor" : [ 1.0, 1.0, 1.0, 0.46 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 121.0, 250.0, 20.848206000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 203.0, 21.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 239.0, 163.0 ],
					"proportion" : 0.39,
					"rounded" : 7,
					"varname" : "displaybg"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 174.0, 60.0, 174.0, 60.0, 360.0, 71.0, 360.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 207.0, 60.0, 207.0, 60.0, 360.0, 81.5, 360.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 237.0, 60.0, 237.0, 60.0, 360.0, 92.0, 360.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 270.0, 60.0, 270.0, 60.0, 360.0, 102.5, 360.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 303.0, 60.0, 303.0, 60.0, 360.0, 113.0, 360.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.5, 360.0, 123.5, 360.0 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"parameters" : 		{
			"obj-1::obj-14" : [ "Map[1]", "Map", 0 ],
			"obj-1::obj-28" : [ "Unmap[1]", "Unmap", 0 ],
			"obj-1::obj-3" : [ "TargetMax[7]", "Max", 0 ],
			"obj-1::obj-33" : [ "border[2]", "border", 0 ],
			"obj-1::obj-4" : [ "mode[1]", "mode", 0 ],
			"obj-1::obj-8" : [ "TargetMin[7]", "Min", 0 ],
			"obj-1::obj-9" : [ "border[1]", "border", 0 ],
			"obj-23" : [ "Show Multimap[3]", "Multimap", 0 ],
			"obj-3::obj-14" : [ "Map[2]", "Map", 0 ],
			"obj-3::obj-28" : [ "Unmap[2]", "Unmap", 0 ],
			"obj-3::obj-3" : [ "TargetMax[1]", "Max", 0 ],
			"obj-3::obj-33" : [ "border[4]", "border", 0 ],
			"obj-3::obj-4" : [ "mode[2]", "mode", 0 ],
			"obj-3::obj-8" : [ "TargetMin[1]", "Min", 0 ],
			"obj-3::obj-9" : [ "border[3]", "border", 0 ],
			"obj-4::obj-14" : [ "Map[3]", "Map", 0 ],
			"obj-4::obj-28" : [ "Unmap[3]", "Unmap", 0 ],
			"obj-4::obj-3" : [ "TargetMax[2]", "Max", 0 ],
			"obj-4::obj-33" : [ "border[5]", "border", 0 ],
			"obj-4::obj-4" : [ "mode[3]", "mode", 0 ],
			"obj-4::obj-8" : [ "TargetMin[2]", "Min", 0 ],
			"obj-4::obj-9" : [ "border[6]", "border", 0 ],
			"obj-5::obj-14" : [ "Map[4]", "Map", 0 ],
			"obj-5::obj-28" : [ "Unmap[4]", "Unmap", 0 ],
			"obj-5::obj-3" : [ "TargetMax[8]", "Max", 0 ],
			"obj-5::obj-33" : [ "border[7]", "border", 0 ],
			"obj-5::obj-4" : [ "mode[4]", "mode", 0 ],
			"obj-5::obj-8" : [ "TargetMin[3]", "Min", 0 ],
			"obj-5::obj-9" : [ "border[8]", "border", 0 ],
			"obj-6::obj-14" : [ "Map[5]", "Map", 0 ],
			"obj-6::obj-28" : [ "Unmap[5]", "Unmap", 0 ],
			"obj-6::obj-3" : [ "TargetMax[9]", "Max", 0 ],
			"obj-6::obj-33" : [ "border[10]", "border", 0 ],
			"obj-6::obj-4" : [ "mode[5]", "mode", 0 ],
			"obj-6::obj-8" : [ "TargetMin[4]", "Min", 0 ],
			"obj-6::obj-9" : [ "border[9]", "border", 0 ],
			"obj-7::obj-14" : [ "Map[8]", "Map", 0 ],
			"obj-7::obj-28" : [ "Unmap[8]", "Unmap", 0 ],
			"obj-7::obj-3" : [ "TargetMax[11]", "Max", 0 ],
			"obj-7::obj-33" : [ "border[16]", "border", 0 ],
			"obj-7::obj-4" : [ "mode[8]", "mode", 0 ],
			"obj-7::obj-8" : [ "TargetMin[8]", "Min", 0 ],
			"obj-7::obj-9" : [ "border[15]", "border", 0 ],
			"obj-8::obj-14" : [ "Map[6]", "Map", 0 ],
			"obj-8::obj-28" : [ "Unmap[6]", "Unmap", 0 ],
			"obj-8::obj-3" : [ "TargetMax[3]", "Max", 0 ],
			"obj-8::obj-33" : [ "border[12]", "border", 0 ],
			"obj-8::obj-4" : [ "mode[6]", "mode", 0 ],
			"obj-8::obj-8" : [ "TargetMin[5]", "Min", 0 ],
			"obj-8::obj-9" : [ "border[11]", "border", 0 ],
			"obj-9::obj-14" : [ "Map[7]", "Map", 0 ],
			"obj-9::obj-28" : [ "Unmap[7]", "Unmap", 0 ],
			"obj-9::obj-3" : [ "TargetMax[10]", "Max", 0 ],
			"obj-9::obj-33" : [ "border[14]", "border", 0 ],
			"obj-9::obj-4" : [ "mode[7]", "mode", 0 ],
			"obj-9::obj-8" : [ "TargetMin[6]", "Min", 0 ],
			"obj-9::obj-9" : [ "border[13]", "border", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				"name" : "MapButton.maxpat",
				"bootpath" : "~/dev/m4l-zs-AutomationMath",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
